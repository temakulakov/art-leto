    ...
    return (
        <div className={styles.root}>
            ...
            {!isLoading && !isError && monthsJSX.map((month, index) => (
                ...
                >
                    {!isMobile ? <Line color={month.color} word={month.title} /> : <h3  style={{marginLeft: '1.5vw'}} ref={el => headingRefs.current[index] = el}>{month.title}</h3>}
                    {data ? (
