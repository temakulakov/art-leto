...
const testEvents: IEvent[] = [
	{
		...
		dateTime: dayjs('2025-06-01 15:00', 'YYYY-MM-DD HH:mm'),
		duration: 90,
		rating: 6,
		imageLink:
	...
	},
	{
		...
		dateTime: dayjs('2025-08-03 12:00', 'YYYY-MM-DD HH:mm'),
		duration: 90,
		rating: 6,
		imageLink:
	...
	},
	{
		...
		dateTime: dayjs('2025-08-07 15:00', 'YYYY-MM-DD HH:mm'),
		duration: 60,
		rating: 3,
		imageLink:
	...
	},
	{
		...
		dateTime: dayjs('2025-07-14 17:00', 'YYYY-MM-DD HH:mm'),
		duration: 60,
		rating: 3,
		imageLink:
	...
	},
	{
		...
		dateTime: dayjs('2025-08-17 12:00', 'YYYY-MM-DD HH:mm'),
		duration: 90,
		rating: 6,
		imageLink:
	...
	},
	{
		...
		dateTime: dayjs('2025-08-21 15:00', 'YYYY-MM-DD HH:mm'),
		duration: 90,
		rating: 6,
		imageLink:
			'https://www.bakhrushinmuseum.ru/wp-content/uploads/2024/06/photo1717060771-7.jpeg',
	...
	},
	{
		...
		dateTime: dayjs('2025-08-24 12:00', 'YYYY-MM-DD HH:mm'),
		duration: 120,
		rating: 6,
		imageLink:
